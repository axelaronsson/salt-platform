                ...
                <div className={protypsStyles.categories}>
                    <div className={protypsStyles.programmer}>
                        ...
                        <ul>
                            ...
                            <li><a target="_blank" href="https://appliedtechnology.github.io/protips/planningAProject">Planning a project</a></li>
                    ...
                    <div className={protypsStyles.javascript}>
                        <h3>JavaScript</h3>
                        <ul>
                            <li><a target="_blank" href="https://appliedtechnology.github.io/protips/passingFunctions">Callbacks I</a></li>
